    ...
    return {
        ...
        "network": {
            ...
            "retryable_transport_exceptions": [
                "TimeoutError",
                "ConnectionError including ConnectionResetError",
                "http.client.RemoteDisconnected",
                "urllib.error.URLError and equivalent RuntimeFailure wrapper",
            ],
            "raw_timeout_error_is_retryable": True,
            "network_access_flag_persisted_before_first_request": True,
            "network_attempt_event": "One pre-request event supplies the event ID and timestamp used by the ledger, run state, failure record and provenance.",
        },
        "source_and_search": {
