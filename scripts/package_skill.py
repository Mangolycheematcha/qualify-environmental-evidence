...
RESOURCE_PATHS = (
    ...
    "config/semantic-boundaries.json",
    "config/statement-templates.json",
    "schemas/evidence-memory-document.schema.json",
    ...
    "data/cer/README.md",
    "data/cer/accu-smc-public-definitions.json",
    "data/cer/corpus-manifest.json",
    "data/cer/eop100183-project-record.json",
    "data/cer/eop101053-project-record.json",
    "data/cer/eop101126-project-record.json",
    "data/cer/eop101132-project-record.json",
    "data/cer/erf101444-project-record.json",
    "data/cer/erf108333-project-record.json",
    "data/cer/erf169256-project-record.json",
    "data/cer/safeguard-2024-25-arcadia.json",
    "evaluation/held-out-freeze.json",
    "evaluation/qualification-benchmark.json",
    "evaluation/retrieval-benchmark.json",
    "examples/qualification/accu-smc-boundary-request.json",
    "examples/qualification/eop101132-frozen-observation.json",
    "examples/qualification/eop101132-request.json",
    ...
    "scripts/evaluate_qualification.py",
    "scripts/evaluate_retrieval.py",
    "scripts/qualification_session.py",
    "scripts/qualification_workflow.py",
    "scripts/retrieval_memory.py",
    "scripts/run_e2e_demos.py",
