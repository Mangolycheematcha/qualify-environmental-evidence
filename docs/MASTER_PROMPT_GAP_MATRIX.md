...
Verified 2026-09-05. `COMPLETE` requires implementation plus executed evidence. `BLOCKED` names the exact external dependency; repository-authored fixtures never count as human or model behaviour.
...
| R3 | 60-100 partitioned cases and frozen held-out | 80 total, 53 development, 27 held-out; no group leakage | `COMPLETE` |
...
| R6 | Retrieval and separate stores | 25 held-out queries; all modes 25/25 Top-1; separate evidence/checkpoint/preference stores | `COMPLETE` |
| R7 | Four E2E journeys and replay | 4/4; missing/stale/conflict included; pause/resume/replay bytes equal | `COMPLETE` |
| R8 | Security evaluation | 8 executed threats, 2 explicitly N/A, 10 controls pass; exclusions named | `COMPLETE_FOR_LOCAL_POC` |
...
| R12 | Full verification, hashes, diff, commits | 312 tests; generated checks; 336/336 frozen checksum entries; focused commits `9d12ff0`, `be3c39e`, `cd5e0a3` | `COMPLETE` |
