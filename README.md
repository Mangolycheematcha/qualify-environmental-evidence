...
| Area | Status |
|---|---|
| Contract and platform implementation | Completed through contract `0.4.0`; `0.5.0` is proposed for V4 semantics |
| First live source run | Completed and correctly abstained at the frozen V3 resource gate |
| Real raster and NDVI path | Not yet executed |
...
V4 is a pending policy proposal. It keeps the 40-acquisition raster-processing limit but applies it after deterministic metadata-only grouping and admissibility checks. It is not approved and cannot be executed until a human binds an explicit mode to its exact policy hash.

Pending V4 policy SHA-256: `3412570f327f4c55184ced99948f3625e718e19e994732ec204cb7dea16318dd`.
...
- The raster alignment, radiometry, coverage, NDVI, and end-to-end replay path with derived arrays remain unexecuted.
